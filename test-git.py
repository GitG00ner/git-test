...
if "schoolsoft" == "schoolsoft":
    ...
    print("hur?")
    print("det är någonting konstigt på gång")

print("jag kommer med fler updateringar snart, altså aldrig. Men aja kommer andra förhoppningsvis roliga projekt senare!")
